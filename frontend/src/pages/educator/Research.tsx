...
const Research: React.FC<RouteComponentProps> = () => (
  <PageWrapper>
    <Heading>Research</Heading>
    <P>
      Welcome to 4-H Military Partnerships! As an Research/Staff Member, there are a number of resources to support 4-H
